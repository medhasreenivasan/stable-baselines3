...
class RolloutBuffer(BaseBuffer):
    ...
    :param n_envs: Number of parallel environments
    :param n_step_advantage:  If set to True, the working of compute_returns_and_advantage in buffers.py will use n-step bootstrap method for estimation of V values #modified
    """
    ...
    def __init__(
        ...
        self.n_step_advantage = n_step_advantage  ## modified
        self.gamma = gamma
    ...
    def compute_returns_and_advantage(self, last_values: th.Tensor, dones: np.ndarray) -> None:
        ...
        ## Fetch the value of n_step_advantage
        n_step_advantage = self.n_step_advantage #modified
